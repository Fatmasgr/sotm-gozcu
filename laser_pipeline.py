...
Bu modül, ileride:
  Görüntü işleme -> arayüz -> ana işlemci -> pan-tilt güdüm
zincirine bağlanacak `TargetingData` nesnesini üretir.
Motor kontrolü / pan-tilt entegrasyonu bilerek eklenmemiştir.
